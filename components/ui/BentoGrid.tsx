    ...
    >
      <div className={`${id === 4 && 'flex justify-center'}  h-full  `}>
        ...
        {img && (
            ...
            src={img}
            alt={img}
            className={cn(imgClassName,  `${id === 1 ? "md:pl-[390px] md:pt-0 lg:pl-24 lg:pr-24 lg:pt-52 top-auto bottom-0 md:object-contain lg:object-fill" : "object-cover object-center"}`
            )}/>
          )}
        </div>
        {id === 4 && (
